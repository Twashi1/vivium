...
Mat2x2 Mat2x2::transpose() { return Mat2x2(m00, m10, m01, m11); }

F32x2 operator*(Mat2x2 matrix, F32x2 vec) {
  return F32x2(matrix.m00 * vec.x + matrix.m10 * vec.y,
...
Mat2x2 Mat2x2::identity() { return Mat2x2(1.0f, 0.0f, 0.0f, 1.0f); }
}  // namespace Vivium