...
typedef void (*ArbitraryUpdatePtr)(GUIElementReference reference, void* data,
                                   F32x2 windowDimensions,
...
void _updateContainer(GUIElementReference reference,
                      ...
                      F32x2 windowDimensions, GUIContext& guiContext);
// TODO: versions of these functions for general objects, like Button, Text,
// etc.
void updateGUIElement(GUIElementReference const objectHandle,
...
GUIElementReference _extractGUIReference(T const& object) {
  if constexpr (std::is_same_v<T, GUIElementReference>) {
    return object;
  } else {
    return object.base;
  }
