...
void renderSprites(CommandContext& context, GUIContext& guiContext,
  ...
  setBuffer(guiContext.sprite.storageBuffer.resource, 0,
            guiContext.sprite.sprites.data(),
            guiContext.sprite.sprites.size() * sizeof(_GUISpriteInstanceData));
  ...
  cmdBindDescriptorSet(context, guiContext.sprite.descriptorSet.resource,
                       guiContext.sprite.pipeline.resource);
