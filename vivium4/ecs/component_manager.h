...
namespace Vivium {
	...
	* 
	* No requirement to preserve the memory at source, can be invalidated for performance.
	* 
	...
	*
	* No requirement to preserve the memory of any individual component at source. The list of components is continguous in memory.
	*
	* \tparam T The type of component to move.
	* \param source The source memory to copy from.
	* \param dest The destination memory to copy to.
	* \param count The number of components to move - assumed to be the whole list often.
	*/
	template <ValidComponent T>
	...
	* 
	* No guarantee that a and b will be different addresses or different components.
	* 
